    ...
    <div className={styles.container}>
      <div className={styles.textContainer}>
        ...
        <p className={styles.desc}>
          Welcome everyone, welcome to VelynAPI document home page. You can retrieve api data only in NV Api and certainly without incurring any costs in data retrieval, 
